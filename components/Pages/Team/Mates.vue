<template>
  <section class="py-4 lg:py-8 xl:py-16">
    <div class="container mx-auto px-6">
      ...
      <p class="mb-4 text-justify text-xl leading-relaxed text-gray-200">
      ...
      <div class="flex flex-wrap">
        <div
          ...
          :key="index"
          class="mx-auto my-2 flex flex-col items-center p-4"
        >
          <img
            :src="avatar.pathLong"
            :alt="`${alt} - ${avatar.name}`"
            class="h-32 w-32 rounded-[100%] border-4 border-solid border-gray-100"
          />
          <h4 class="mt-2 text-center font-serif text-2xl text-gray-200">
            {{ avatar.name }}
          </h4>
        </div>
      </div>
...
img {
  &:hover {
    @apply scale-105 border-0 transition-all;
  }
}
</style>
